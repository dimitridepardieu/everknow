...
function SplashPage() {
  return (
    <main
      className="relative mx-auto flex min-h-dvh max-w-md flex-col overflow-hidden pt-[50px] pb-[34px] text-white"
      style={{
        background:
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-2.5 px-5">
        <Link
          to="/register"
          className={cn(
